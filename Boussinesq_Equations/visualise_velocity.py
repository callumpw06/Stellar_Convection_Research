"""
This is a python script to visualise the magnitude of the velocity field of a 2D Rayleigh-Benard convection 
simulation in the Dedalus framework. It loads the velocity magnitude field from the HDF5 files generated
by the simulation and creates a contour plot of the velocity magnitude field at a specified time step.
"""
...
field_to_plot = 'velocity_magnitude'
output_movie = 'velocity_magnitude_fixed.mp4'
