"""
This is a python script to visualise the pressure field of a 2D Rayleigh-Benard convection 
simulation in the Dedalus framework. It loads the pressure field from the HDF5 files generated
by the simulation and creates a contour plot of the pressure field at a specified time step.
"""
...
field_to_plot = 'pressure'
output_movie = 'pressure_fixed.mp4'
