"""
This is a python script to visualise the vorticity field of a 2D Rayleigh-Benard convection 
simulation in the Dedalus framework. It loads the vorticity field from the HDF5 files generated
by the simulation and creates a contour plot of the vorticity field at a specified time step.
"""
...
field_to_plot = 'vorticity'
output_movie = 'vorticity_fixed.mp4'
