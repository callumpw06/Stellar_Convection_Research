...
#for Lx in Lx_values:
    ...
    #subprocess.run([sys.executable, "forward_solver.py", str(Lx), BC, str(Rayleigh)], check=True)
...
for Lx in Lx_values:
    ...
    for file in files:
        with h5py.File(file, 'r') as f:
            T_dataset = f['tasks']['T_bar']
            w_dataset = f['tasks']['u_bar'][:, 1]  # Assuming w is the vertical component of u_bar
