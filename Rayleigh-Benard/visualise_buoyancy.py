"""
This is a python script to visualise the buoyancy field of a 2D Rayleigh-Benard convection 
simulation in the Dedalus framework. It loads the buoyancy field from the HDF5 files generated
by the simulation and creates a contour plot of the buoyancy field at a specified time step.
"""
...
from Rayleigh_Benard_2D import Lx, Lz # Import Lx and Lz from the simulation script

# Configuration
data_folder = 'analysis'
field_to_plot = 'buoyancy'
output_movie = 'buoyancy_fixed.mp4'
